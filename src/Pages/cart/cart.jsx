...
<div>
  {cartData && cartData.length > 0 ? (
    <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start px-4 py-8">
      
      {/* Cart Table Section */}
      <div className="flex flex-col items-center mt-8 w-full lg:w-2/3 lg:ml-20 rounded-sm"
           style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
        <h2 className="bg-[#EFEFF4] text-[#3C3C3C] p-4 lg:p-8 rounded-t-md w-full text-center">My Cart</h2>
      ...
      <div className="mt-8 w-full lg:w-1/3 rounded-md lg:mr-20"
           style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
        <h2 className="text-xl font-semibold border-b border-grey px-2 py-4 text-[#3C3C3C] text-center lg:text-left">Payment Summary</h2>
