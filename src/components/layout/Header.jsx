                ...
                <div className="flex items-center space-x-4   relative">
                    <Link to="/cart">
                        <button className="text-gray-600 hover:text-[#24B9D7] focus:outline-none focus:ring-2 focus:ring-[#24B9D7] focus:ring-offset-2 p-2 rounded-md">
                            ...
                            <span className="sr-only ">Cart{CartData?.cartData?.length}</span>
            ...
            {isMobileMenuOpen && (
                <nav className="lg:hidden mt-4 py-4 border-t border-gray-200">
                    <ul className="flex flex-col space-y-2">
                        <li>
                            <Link to="/signIn" className="w-full text-left px-4 py-2 text-gray-600 hover:bg-gray-100 hover:text-[#24B9D7] font-medium">
                                Login
                            </Link>
                        </li>
                        <li>
                            <Link to="/signUp" className="w-full text-left px-4 py-2 bg-[#24B9D7] text-white hover:bg-[#24B9D7] focus:outline-none focus:ring-2 focus:ring-[#24B9D7] focus:ring-offset-2 rounded-md">
                                Sign Up
                            </Link>
                        </li>
                    </ul>
