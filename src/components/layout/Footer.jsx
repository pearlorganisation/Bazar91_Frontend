      ...
      <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
          <div className="gap-6 justify-between md:flex">
              <div className="flex-1">
                  <div className="max-w-xs">
                      <img src="https://bazar91.com/img/logo-1721309114.jpg" className="w-32 cursor-pointer" />
                  ...
                  >
                      ...
                      <div className="max-w-sm flex items-center border rounded-md p-1">
                          ...
                          />
                          <button
                              className="p-2.5 rounded-md text-white bg-[#24B9D7] outline-none shadow-md focus:shadow-none sm:px-5"
                          >
                              Subscribe
                          </button>
                      </div>
          ...
          <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
              <div className="mt-4 sm:mt-0">
                  &copy; 2024 Bazar91 All rights reserved.
              </div>
